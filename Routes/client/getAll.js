    ...
    try {
        let result = await Client.find(
            {},
            {
                ...
                ["y2022" + ".signaletique.contribuable.date_de_naissance"]: 1,
                ["y2022" + ".signaletique.conjoint_partenaire.date_de_naissance"]: 1,
                ["y2022" + ".signaletique.conjoint_partenaire.nom"]: 1,
                ["y2022" + ".depenses_speciales14.plafond_672"]: 1,
                ["y2022" + ".depenses_speciales15.prevoyance_vieillesse_t2.contribuable.plafond_3200"]: 1,
                ["y2022" + ".depenses_speciales15.prevoyance_vieillesse_t2.conjoint_partenaire.plafond_3200"]: 1,
                ["y2022" + ".depenses_speciales14.montant_moins_eleve"]: 1
            }
        ).exec();
        res.send(result);
    } catch (err) {
