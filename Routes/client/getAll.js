    ...
    try {
        let result = await Client.find(
            {},
            {
                ...
                ["y2019" + ".signaletique.conjoint_partenaire.prenom"]: 1,
                ["y2019" + ".depenses_speciales15.prevoyance_vieillesse_t2.contribuable.plafond_3200_total"]: 1,
                ...
                ["y2020" + ".signaletique.conjoint_partenaire.prenom"]: 1,
                ["y2020" + ".depenses_speciales15.prevoyance_vieillesse_t2.contribuable.plafond_3200_total"]: 1
            }
        ).exec();
        res.send(result);
    } catch (err) {
