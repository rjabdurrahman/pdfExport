...
router.post('/infoupdate/:id', (req, res) => {
    ...
    let data = { ...page1(info), ...page2(info), ...page3(info), ...page4(info), ...page5(info), ...page6(info), ...page7(info), ...page8(info), ...page9(info), ...page10(info), ...page11(info), ...page12(info), ...page13(info), ...page14(info), ...page15(info), ...page16(info), ...page17_18(info), ...page19(info)};
